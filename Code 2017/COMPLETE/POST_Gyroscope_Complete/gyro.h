...
namespace Gyro{
 ...
 void gyroAddError(){gyro_error++;}
 boolean gyroWaitForBits(int sizeOFIn=1){gyroerror_curCount=0;while(Wire.available()<sizeOFIn&&gyroerror_curCount<gyroerror_minCount){gyroerror_curCount++;}if(gyroerror_curCount>=gyroerror_minCount){gyroAddError();return false;}return true;}
